...
#[test]
fn calculate_bit_perfect_not_exclusive() {
    let track = create_test_track_info(44100, 16);
...
#[test]
fn calculate_bit_perfect_resampling_active() {
    let track = create_test_track_info(44100, 16);
...
#[test]
fn calculate_bit_perfect_sample_rate_mismatch() {
    let track = create_test_track_info(44100, 16);
...
#[test]
fn calculate_bit_perfect_bit_depth_mismatch() {
    let track = create_test_track_info(44100, 16);
...
#[test]
fn calculate_bit_perfect_all_mismatch() {
    let track = create_test_track_info(44100, 16);
...
#[test]
fn is_format_conversion_active_both_none() {
    assert!(!is_format_conversion_active(None, None));
}

#[test]
fn is_format_conversion_active_track_none() {
    let config = create_test_output_config(44100, 24, true, false, None, 50);
    assert!(!is_format_conversion_active(None, Some(&config)));
}

#[test]
fn is_format_conversion_active_config_none() {
    let track = create_test_track_info(44100, 16);
    assert!(!is_format_conversion_active(Some(&track), None));
}

#[test]
fn is_format_conversion_active_true() {
    let track = create_test_track_info(44100, 16);
    let config = create_test_output_config(44100, 24, true, false, None, 50);
...
#[test]
fn is_format_conversion_active_same_bits() {
    let track = create_test_track_info(44100, 16);
    let config = create_test_output_config(44100, 16, true, false, None, 50);
    assert!(!is_format_conversion_active(Some(&track), Some(&config)));
}
...
#[test]
fn is_format_conversion_active_resampling() {
    let track = create_test_track_info(44100, 16);
...
#[test]
fn is_format_conversion_active_sample_rate_mismatch() {
    let track = create_test_track_info(44100, 16);
...
#[test]
fn is_lossy_device_bluetooth_headset() {
    let config = create_test_output_config(
        44100,
        16,
        false,
...
#[test]
fn is_lossy_device_case_insensitive() {
    let config = create_test_output_config(
        44100,
        16,
        false,
...
#[test]
fn calculate_hifi_button_class_lossy() {
    let track = create_test_track_info(44100, 16);
    assert_eq!(
...
#[test]
fn calculate_hifi_button_class_perfect_and_gapless() {
    let track = create_test_track_info(44100, 16);
    assert_eq!(
...
#[test]
fn calculate_hifi_button_class_perfect_no_gapless() {
    let track = create_test_track_info(44100, 16);
    assert_eq!(
...
#[test]
fn calculate_hifi_button_class_not_perfect() {
    let track = create_test_track_info(44100, 16);
    assert_eq!(
...
#[test]
fn calculate_hifi_button_class_compromised_no_gapless() {
    let track = create_test_track_info(44100, 16);
    assert_eq!(
