...
mod tests {
    ...
    fn embedded_artwork_flac() -> Result<()> {
    ...
    #[test]
    #[ignore = "Requires test audio files"]
    fn embedded_artwork_mp3() -> Result<()> {
    ...
    #[test]
    #[ignore = "Requires test audio files"]
    fn artwork_extraction_fallback() -> Result<()> {
    ...
    #[test]
    #[ignore = "Requires test audio files"]
    fn metadata_extraction_with_artwork() -> Result<()> {
        let test_file = Path::new("testdata/flac_with_artwork.flac");
        if test_file.exists() {
